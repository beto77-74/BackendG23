...
texto = 'Hola, me llamo eduardo y me gustaria contarles una historia'
# necesito saber cuantas vocales hay en el texto y cuantos espacios 
# tengo, asi mismo si encuentro una letra 'z' debo terminar el bucle
